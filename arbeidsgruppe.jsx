...
function Hero() {
  return (
    <section className="hero" id="top">
      <img className="hero-image" src="images/aufguss-plunge.webp" alt="Gruppe ved fjorden på Son Spa" />
      ...
      <div className="hero-content">
        <div className="hero-top">
          ...
          <div className="hero-meta-block">
            <span className="label">For arbeidsgrupper og team</span>
        ...
        <div>
          <h1 className="hero-headline">
            En felles pause<br/><em>som faktisk gjør noe.</em>
          </h1>
          <div className="hero-bottom">
            <div>
              <p className="hero-sub">
                Et evidensbasert mindfulness-retreat for arbeidsgrupper og team. Tre dager med meditasjon, undervisning og hvile ved Oslofjorden som gir kollegene dine verktøy de tar med hjem.
              </p>
    ...
    <section id="hvorfor" style={{ padding: "100px 0" }}>
      <div className="shell">
        <div className="chapters-head">
          ...
          <div></div>
          <h2>
            <em className="editorial">En annen type</em><br/>teamtur.
          </h2>
        </div>
  ...
  return (
    <section className="final" id="kontakt">
      <div className="final-inner">
        ...
        <h2>
          Klar for en pause<br/><em>som faktisk gjør noe?</em>
        </h2>
        <p>
